...
StateStatistics ClientStateBtreeStorage::counts() const {
...
// ClientStateBtreeStorage::Scope::Scope(Metrics &m, Metrics::Operation oper)
//     : m(m), oper(oper) {
//   //m.counter().start_watch();
// }

// ClientStateBtreeStorage::Scope::~Scope() {
...
tl::expected<types::Order, Error> ClientStateBtreeStorage::findOrder(types::IdType orderid) const {
...
ClientStateBtreeStorage::findOrderByClordId(types::FixClOrdIdType clordid) const {
...
ClientStateBtreeStorage::findBasket(types::IdType basketid) const {
...
tl::expected<types::Route, Error> ClientStateBtreeStorage::findRoute(types::IdType routeid) const {
...
ClientStateBtreeStorage::findRouteByClordId(types::FixClOrdIdType clordid) const {
...
tl::expected<types::Fill, Error> ClientStateBtreeStorage::findFill(types::IdType fillid) const {
...
ClientStateBtreeStorage::findOrdersForBasketId(types::IdType basket_id) const {
...
ClientStateBtreeStorage::findRoutesForOrderId(types::IdType order_id,
...
ClientStateBtreeStorage::findFillsForRouteId(types::IdType route_id,
...
std::vector<types::Fill>
ClientStateBtreeStorage::findFillsForOrderId(types::IdType order_id,
                                             types::ExecStatus status_match) const {
...
ClientStateBtreeStorage::addBasket(types::Basket &&basket) {
...
tl::expected<types::IdType, Error> ClientStateBtreeStorage::addOrder(types::Order &&order) {
...
ClientStateBtreeStorage::addRouteForOrder(types::Route &&route, types::IdType order_id) {
...
tl::expected<types::IdType, Error>
ClientStateBtreeStorage::addOrderForBasket(types::Order &&order, types::IdType basket_id) {
...
tl::expected<types::IdType, Error>
ClientStateBtreeStorage::addFillForRoute(types::Fill &&fill, types::IdType route_id) {
...
tl::expected<void, Error> ClientStateBtreeStorage::updateRouteForOrder(types::Route &&route) {
