...
public:
  ...
  findOrdersForBasketId(types::IdType basket_id) const;
  ...
  addBasket(types::Basket &&) = 0;
  virtual tl::expected<types::IdType, types::Error>
  addOrder(types::Order &&) = 0;
  virtual tl::expected<types::IdType, types::Error>
  addRouteForOrder(types::Route &&, types::IdType order_id) = 0;
  virtual tl::expected<types::IdType, types::Error>
  addOrderForBasket(types::Order &&, types::IdType basket_id) = 0;
  virtual tl::expected<types::IdType, types::Error>
  addFillForRoute(types::Fill &&, types::IdType route_id) = 0;
  virtual tl::expected<types::IdType, types::Error>
  ...
  updateRouteForOrder(types::Route &&) = 0;
  virtual tl::expected<void, types::Error>
  updateFillForRoute(types::Fill &&) = 0;

  virtual tl::expected<void, types::Error>
  deleteBasket(types::IdType basket_id) = 0;
  virtual tl::expected<void, types::Error>
  deleteOrder(types::IdType order_id) = 0;
  virtual tl::expected<void, types::Error>
  deleteRouteForOrder(types::IdType route_id) = 0;
  virtual tl::expected<void, types::Error>
  deleteFillForRoute(types::IdType fill_id) = 0;
};
